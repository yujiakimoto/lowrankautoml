...
def generate_headings(selected_algorithms, selected_hyperparameters):
        ...
        all_hyperparameters = [{'k':[1,3,5,7,9,11,13,15], 'P':[1, 2]}, {'min_samples_split':[2,4,8,16,32,64,128,256,512,1024, 0.01, 0.001, 0.0001, 0.00001]},
                           {'learning_rate':[0.001,0.01,0.025,0.05,0.1,0.25,0.5], 'max_depth':[3, 6], 'max_features':[None, 'log2']}, {'C':[0.125,0.25,0.5,0.75,1,2,4,8,16]},
                           {'C':[0.125,0.25,0.5,0.75,1,2,4,8,16], 'kernel':['rbf', 'poly'], 'coef0':[0, 10]}, {'C':[0.25,0.5,0.75,1,1.5,2,3,4], 'Solver':['liblinear', 'saga'], 'penalty':['l1', 'l2']}, {}, {}, {},
                           {'min_samples_split':[2,4,8,16,32,64,128,256,512,1024, 0.1, 0.01, 0.001, 0.0001, 0.00001], 'criterion': ['gini', 'entropy']}, {'min_samples_split':[2,4,8,16,32,64,128,256,512,1024,0.1,0.01,0.001,0.0001,0.00001], 'criterion':['gini', 'entropy']},
        ...
        less_hyperparameters = [{'k':[1,3,5,7,9,11,13,15], 'P':[2]}, {'min_samples_split':[0.01, 0.001, 0.0001, 0.00001]},
                                {'learning_rate':[0.1, 0.01, 0.001]}, {'C':[0.25, 0.5, 0.75, 1.0, 2.0]}, {'C':[0.25,0.5,0.75,1.0,2.0]}, {'C':[0.25,0.5,0.75,1.0,2.0]},
        ...
        #alg_types: a list containing algorithms correspond to each column, e.g. ['kNN', 'kNN', 'CART'];
        #hyperparameter_names: a list containing tuples, with first entries of each tuple being the hyperparameter name corresponding to that column;
        #hyperparameter_values: a list containing tuples, with first entries of each tuple being the hyperparameter value corresponding to that column.
